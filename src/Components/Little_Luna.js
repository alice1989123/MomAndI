  ...
  return (
    ...
    >
      <Box className={styles.container}>
        ...
        <TextWrapper
          body={`A mother with her child happened to be walking nearby at that moment and couldn’t help but mention how cute this was. Luna’s Mom smiled at the woman and explained that her daughter likes to do so, stopping at stop signs, touching them and saying hello, ever since she was one year old and that “STOP” is the first word she can actually spell on her own.
          That woman was also walking with her son to the park, so all four ended up going there together, where she had the chance to chat with Luna’s mom and see the little painter’s work.
        ...
        <TextWrapper
          ...
          Two days have passed and her memory began playing tricks on her… Maybe she left the pink file on the playground’s bank!
          She did not hesitate to submit an online application for “the lost and found items” anyway.
          
          Yes, to anyone this can be a superficial matter perhaps, but to Luna‘ s parents, not only are the drawings masterpieces of their precious offspring, but they also are a very meaningful sign and souvenir of a “too early reached” giant milestone!
          
          At first, Luna’s father tried to weigh the guilt and sadness off the mother’s chest by trying to convince her that eventually Luna will draw other paintings. But then he saw how important the nine drawings were to Luna and mom:
          She would take Luna to that same playground whenever she wanted to play, in the hope of meeting that woman again and asking her if she saw that pink file anywhere after they left. Also, little Luna was telling every child she met there about her drawings.`}
        />
        ...
        <TextWrapper
          ...
          body={`She received an MMS from an unknown number. The picture was what looked like a puzzle piece of mixed colors. She ignored it assuming it was sent by mistake.

          A couple of days later, Luna was helping her mom to bake a cake. She insisted on listening to a song. Since mom’s hands were already busy with the dough, she asked Luna to click on the music application icon on her phone. Luna grabbed the mobile and the moment she was holding it, an MMS came through from an unknown number. Luna automatically clicked on the message to open it as her mom was observing. It was another puzzle piece similar to the one sent before. Luna immediately brought her hands to her cheeks with a gaping jaw dropping the phone. As her mother explained that it was nothing serious and that it was sent by mistake, Luna looked at her mother and screamed:” My drawing!” 
          Her mom quickly picked up her phone, froze and held her breath while realizing that it was indeed a piece of one of Luna’s drawings!
          
          She hugged her little girl to soothe her reaction while trying to give her a positive interpretation of what just happened although she was not sure herself about what she was telling her daughter. 
          Someone eventually has the drawings, exactly as they doubted before.
          But what is their purpose in playing this kind of game?! 
          What is going to happen next?! Are they going to ask for money in return for giving them back? Or will they keep sending them as puzzle pieces in MMS? At least this way they can be put back together to make a soft copy of the drawings. And what if they don’t send the complete pieces of each drawing?
          Luna’s mom was perplexed, and later on Luna’s dad joined the club of confusion. But one thought was giving them a glimpse of hope: The drawings were not lost after all! And they couldn’t help but smile because this means that Luna will soon draw again and her gift will bloom.`}
        >
